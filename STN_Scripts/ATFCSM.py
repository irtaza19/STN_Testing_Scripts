...
SEQUENCE = [
    ...
    ("atd1",              BASE_WAIT_SEC),
    ("0902",              BASE_WAIT_SEC),
    ("atfcsm1",           BASE_WAIT_SEC),
    ("atfcsm2",           BASE_WAIT_SEC),
    ("atfcsd 40 00 00",   BASE_WAIT_SEC),
    ("0902",              BASE_WAIT_SEC),
    ("atfcsm1",           BASE_WAIT_SEC),
    ("atfcsm 2",          BASE_WAIT_SEC),
    ("0902",              BASE_WAIT_SEC),
    ("atfcsd 30 00 00",   BASE_WAIT_SEC),
    ("0902",              BASE_WAIT_SEC),
    ("atfcsh 777",        BASE_WAIT_SEC),
    ("0902",              BASE_WAIT_SEC),
    ("atfcsm2",           BASE_WAIT_SEC),
    ("0902",              BASE_WAIT_SEC),
    ("strstnvm",          WAIT_AFTER_STRSTNVM),
    ("atfcsd 30 00 00",   BASE_WAIT_SEC),
    ("atfcsh 777",        BASE_WAIT_SEC),
    ("atfcsm 1",          BASE_WAIT_SEC),
    ("0902",              10),
    ("0902",              BASE_WAIT_SEC),
    ("strstnvm",          WAIT_AFTER_STRSTNVM),
    ("atl1",              BASE_WAIT_SEC),
    ("atfcsd 40 00 00",   BASE_WAIT_SEC),
    ("atfcsh 7e8",        BASE_WAIT_SEC),
    ("atfcsm 1",          BASE_WAIT_SEC),
    ("0902",              10),
    ("strstnvm",          WAIT_AFTER_STRSTNVM),
    ("atl1",              BASE_WAIT_SEC),
