...
SEQUENCE = [
    ...
    ("STGPOR", BASE_WAIT_SEC),
    ("STGPOR 1", BASE_WAIT_SEC),
    ("STGPOR 25", BASE_WAIT_SEC),
    ("STGPOR 1,4", BASE_WAIT_SEC),
    ("STGPOR 1,4,3", BASE_WAIT_SEC),
    ("STGPOR 1,25", BASE_WAIT_SEC),
    ("STGPOR 1:0", BASE_WAIT_SEC),
    ("STGPOR 1,", BASE_WAIT_SEC),
    ("STGPOR ,1", BASE_WAIT_SEC),
    ("STGPOR ,", BASE_WAIT_SEC),
]
