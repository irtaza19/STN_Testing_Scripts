...
SEQUENCE = [
    ...
    ("STGPIR", BASE_WAIT_SEC),
    ("STGPIR 1", BASE_WAIT_SEC),
    ("STGPIR 25", BASE_WAIT_SEC),
    ("STGPIR 1,4", BASE_WAIT_SEC),
    ("STGPIR 1,4,3", BASE_WAIT_SEC),
    ("STGPIR 1,25", BASE_WAIT_SEC),
    ("STGPIR 1:0", BASE_WAIT_SEC),
    ("STGPIR 1,", BASE_WAIT_SEC),
    ("STGPIR ,1", BASE_WAIT_SEC),
    ("STGPIR ,", BASE_WAIT_SEC),
]
