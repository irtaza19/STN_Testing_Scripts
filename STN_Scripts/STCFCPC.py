...
IDLE_GAP_SEC        = 1     # stop reading after this much quiet time
READ_SLICE_SLEEP    = 1
BASE_WAIT_SEC       = 4.0
...
SEQUENCE = [
    ...
    ("0902",                10),
    ("0902",                BASE_WAIT_SEC),
    ("STCFCPA 777,777",     BASE_WAIT_SEC),
    ("0902",                BASE_WAIT_SEC),
    ("STCFCPA 7E0,7E8",     BASE_WAIT_SEC),
    ("0902",                BASE_WAIT_SEC),
    ("STCFCPC",             BASE_WAIT_SEC),
    ("0902",                BASE_WAIT_SEC),
    ("STCFCPA 7E8,FFF",      BASE_WAIT_SEC),
    ("0902",                BASE_WAIT_SEC),
    ("STRSTNVM",  WAIT_AFTER_STRSTNVM)
]
