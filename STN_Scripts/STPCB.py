...
SEQUENCE = [
    ...
    ("STPCB", BASE_WAIT_SEC),
    ("STPCB 0", BASE_WAIT_SEC),
    ("STPCB 1", BASE_WAIT_SEC),
    ("STPCB 00", BASE_WAIT_SEC),
    ("STPCB 01", BASE_WAIT_SEC),
    ("STPCB 10", BASE_WAIT_SEC),
    ("STPCB 2", BASE_WAIT_SEC),
    ("STPCB 3", BASE_WAIT_SEC),
    ("STPCB FF", BASE_WAIT_SEC),
    ("STPCB DC", BASE_WAIT_SEC),
    ("STPCB 0,0", BASE_WAIT_SEC),
    ("STPCB ,0", BASE_WAIT_SEC),
    ("STPCB 1,", BASE_WAIT_SEC),
    ("STPCB ,", BASE_WAIT_SEC),
]
