...
STRSTNVM_DELAY      = 3
UART_WAKE_DELAY     = 2
WAKE_STEP           = "__WAKE_STEP__"

# ===== SEQUENCE (exactly as requested; note spaces vs no spaces) =====
SEQUENCE = [
    ("STRSTNVM",        STRSTNVM_DELAY),
    ("STSLCS",          BASE_WAIT_SEC),
    ("STSLU on, on",    BASE_WAIT_SEC),
    ("STSLUIT 10",       BASE_WAIT_SEC),
    ("ATZ",             ATZ_DELAY),
    ("STSLCS",          20), # more delay to make device sleep
    (WAKE_STEP,          UART_WAKE_DELAY),
    ("STSLU off, on",    BASE_WAIT_SEC),
    ("STSLUIT 100",      BASE_WAIT_SEC),
    ("ATZ",             ATZ_DELAY),
    ("STSLCS",          BASE_WAIT_SEC),
]
