...
SEQUENCE = [
    ...
    ("ATL1",     BASE_WAIT_SEC),
    ("AT@1",     BASE_WAIT_SEC),
    ("STS@1 ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890!@#$%^&*()", BASE_WAIT_SEC),
    ("STS@1 012345678901234567890123456789012345678901234 567", BASE_WAIT_SEC),
    ("STS@1   012   345678901234567890123456789012345678", BASE_WAIT_SEC),
    ("STS@1 Testing_Ecleaver", BASE_WAIT_SEC),
    ("AT@1", BASE_WAIT_SEC),
    ("STRSTNVM",  WAIT_AFTER_STRSTNVM)
]
