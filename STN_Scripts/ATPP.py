...
SEQUENCE = [
    ...
    ("ATI", BASE_WAIT_SEC),
    ("0902", 5),
    ("ATPP 01 SV 00",BASE_WAIT_SEC),
    ("ATPP 01 ON",   BASE_WAIT_SEC),
    ("ATPP 09 SV FF",BASE_WAIT_SEC),
    ("ATPP ON",      BASE_WAIT_SEC),
    ("ATPP 0A SV 41",BASE_WAIT_SEC),
    ("ATPP 0A ON",   BASE_WAIT_SEC),
    ("ATPP 0D SV 42",BASE_WAIT_SEC),
    ("ATPP 0D ON",   BASE_WAIT_SEC),
    ("ATPPS",BASE_WAIT_SEC),
    ("ATPP 0D OFF",   BASE_WAIT_SEC),
    ("ATPPS",BASE_WAIT_SEC),
    ("ATPP 0D ON",   BASE_WAIT_SEC),
    ("0902", BASE_WAIT_SEC),
    ("ATZ", BASE_WAIT_SEC),
    ("0902", BASE_WAIT_SEC),
    ("STRSTNVMB", WAIT_AFTER_STRSTNVM),
    ("STRSTNVMB", WAIT_AFTER_STRSTNVM),
    ("0902", 5),
