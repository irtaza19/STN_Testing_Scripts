...
SEQUENCE = [
    ...
    ("STGPIRH", BASE_WAIT_SEC),
    ("STGPIRH 1", BASE_WAIT_SEC),
    ("STGPIRH 25", BASE_WAIT_SEC),
    ("STGPIRH 1,4", BASE_WAIT_SEC),
    ("STGPIRH 1,4,3", BASE_WAIT_SEC),
    ("STGPIRH 1,25", BASE_WAIT_SEC),
    ("STGPIRH 1:0", BASE_WAIT_SEC),
    ("STGPIRH 1,", BASE_WAIT_SEC),
    ("STGPIRH ,1", BASE_WAIT_SEC),
    ("STGPIRH ,", BASE_WAIT_SEC),
]
