...
SEQUENCE = [
    ...
    ("STGPC 0:O", BASE_WAIT_SEC),
    ("STGPC 0:o", BASE_WAIT_SEC),
    ("STGPC 0:O, 3:O", BASE_WAIT_SEC),
    ("STGPC 0:O, 25:O", BASE_WAIT_SEC),
    ("STGPC 25:O", BASE_WAIT_SEC),
    ("STGPC 0:O, 3:0", BASE_WAIT_SEC),
    ("STGPC 0:O:N0", BASE_WAIT_SEC),
    ("STGPC 0:O:NO", BASE_WAIT_SEC),
    ("STGPC 0:O:N0, 3:O:N1", BASE_WAIT_SEC),
    ("STGPC 0:O:NO, 3:O:U0", BASE_WAIT_SEC),
    ("STGPC , 3:O:U0", BASE_WAIT_SEC),
    ("STGPC 0:O:NO,", BASE_WAIT_SEC),
    ("STGPC ,", BASE_WAIT_SEC),
    ("STGPC 0", BASE_WAIT_SEC),
]
