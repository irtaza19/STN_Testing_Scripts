...
SEQUENCE = [
    ...
    ("0902", 7),
    ("STCTOR 1000,1000 ", BASE_WAIT_SEC),
    ("0902", BASE_WAIT_SEC),
    ("STCTOR 1000,1000 ", BASE_WAIT_SEC),
    ("STCTOR 77777,77777 ", BASE_WAIT_SEC),
    ("STCTOR 0,0 ", BASE_WAIT_SEC),
    ("STCTOR 00,00 ", BASE_WAIT_SEC),
    ("STCTOR 1,1 ", BASE_WAIT_SEC),
    ("STCTOR 65535,65535 ", BASE_WAIT_SEC),
    ("STCTOR 65536,65536 ", BASE_WAIT_SEC),
    ("STCTOR 32767,32767 ", BASE_WAIT_SEC),
    ("STCTOR 32768,32768 ", BASE_WAIT_SEC),
]
