...
SEQUENCE = [
    ...
    ("0902", 7),
    ("STCSEGT", BASE_WAIT_SEC),
    ("STCSEGT0", BASE_WAIT_SEC),
    ("STCSEGT1", BASE_WAIT_SEC),
    ("STCSEGT2", BASE_WAIT_SEC),
    ("STCSEGT 00", BASE_WAIT_SEC),
    ("STCSEGT 01", BASE_WAIT_SEC),
    ("STCSEGT 10", BASE_WAIT_SEC),
    ("0902", BASE_WAIT_SEC)
]
