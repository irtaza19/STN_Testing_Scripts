...
SEQUENCE = [
    ...
    ("0902", 7),
    ("STCSTM 13", BASE_WAIT_SEC),
    ("STCSTM 136", BASE_WAIT_SEC),
    ("STCSTM 135", BASE_WAIT_SEC),
    ("STCSTM 135.14099", BASE_WAIT_SEC),
    ("STCSTM 135.14500", BASE_WAIT_SEC),
    ("STCSTM 1.4294967295", BASE_WAIT_SEC),
    ("STCSTM 1.4294967296", BASE_WAIT_SEC),
]
