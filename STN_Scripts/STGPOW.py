...
SEQUENCE = [
    ...
    ("STGPOW", BASE_WAIT_SEC),
    ("STGPOW 1", BASE_WAIT_SEC),
    ("STGPOW 1:0", BASE_WAIT_SEC),
    ("STGPOW 1:O", BASE_WAIT_SEC),
    ("STGPOW 1:2", BASE_WAIT_SEC),
    ("STGPOW 1:0, 4:1", BASE_WAIT_SEC),
    ("STGPOW 1:0, 25:0", BASE_WAIT_SEC),
    ("STGPOW 1:0,", BASE_WAIT_SEC),
    ("STGPOW ,1:0", BASE_WAIT_SEC),
    ("STGPOW ,", BASE_WAIT_SEC),
]
